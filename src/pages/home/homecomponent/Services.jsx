  ...
  return (
    <div className="w-full flex items-center justify-center">
      <section className="relative flex flex-col max-w-(--layout-width) items-center w-full mt-2 sm:mb-15">
        {/* <div className="sm:flex absolute top-20 right-10 flex-col items-start justify-start w-[50px] h-[50px] animationcostume2">
        <img
          src={triangleg}
          alt="triangle white"
        ...
        <div className="w-full">
          <div
            role="tablist"
            className="flex flex-row flex-nowrap w-full sm:w-[85%] lg:w-full "
          >
        ...
        {/* <div className="animationcostume2 hidden xl:flex absolute bottom-30 left-10 flex-col items-start mr-0.5 justify-start w-[50px] h-[50px]">
        <img
          src={triangleg}
          alt="triangle black"
          className="xl:w-[101px] md:w-[70px] xl:h-[101px] md:h-[70px] object-contain"
