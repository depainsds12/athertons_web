...
const ProjectDetail = () => {
  ...
  const renderContentSection = (title, description1, description2, image, index) => {
    ...
    return (
      <div key={index} className="flex flex-col gap-4 text-center lg:text-left lg:gap-4 px-4 md:px-12 pb-5 lg:pb-5 w-full">
        {title && (
          <h3 className="text-[#192437] font-semibold text-[30px] md:text-[40px] leading-[100%] md:mb-6">
            {title}
          </h3>
        )}
        ...
        {hasContent && (
          <>
            <div className={`flex flex-col ${hasImage ? 'lg:flex-row' : ''} gap-4 items-center lg:gap-8 w-full`}>
              ...
              {hasImage && isEven && (
                <div className=" flex-shrink-0 order-1">
                  <img
                    ...
                    className="w-full h-[300px] lg:w-[400px] xl:w-[550px] lg:h-[400px] xl:h-[450px] object-cover"
                  />
                </div>
              )}
              
              <div className={`${hasImage ? 'flex-1' : 'w-full'} text-black font-normal flex justify-center flex-col text-[16px] leading-[28px] ${isEven ? 'order-2' : 'order-1'}`}>
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8 lg:py-12 py-6">
        <div className="flex flex-col lg:flex-row gap-5 items-center lg:gap-16 px-4 md:px-12 py-10 lg:pb-5 font-normal text-[16px] leading-[28px] mt-2">
          {/* Left: Image Gallery */}
            ...
            <div className="flex flex-col lg:w-1/2 w-full items-center">
              <div className="relative w-full max-w-[720px] xl:aspect-[4/3] overflow-visible mb-4 justify-center">
                <img
                  ...
                  className="lg:max-h-[420px] h-full w-full object-cover transition-all duration-300"
                />
        ...
        {data.short_description && (
          <div className="px-4 md:px-12 w-full text-black text-center lg:text-left font-normal text-[16px] leading-[28px] pb-4 lg:pb-10">
