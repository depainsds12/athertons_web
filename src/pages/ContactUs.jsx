...
>
      ...
      <section className="w-full flex flex-col md:flex-row justify-center items-start gap-10 px-4 md:px-10 lg:px-20 xl:px-32 py-16">
        {/* Form Section */}
        ...
        <div className="w-full max-w-[444px] flex flex-col gap-8 p-2 mr-1">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[#03837E] text-sm md:text-lg font-semibold">
