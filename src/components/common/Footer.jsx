      ...
      <div className="w-full bg-[#03837E] flex flex-col  sm:items-center lg:flex-row lg:items-start lg:justify-between px-6 py-10 gap-8">
        ...
        <div className="flex flex-col items-center lg:items-center flex-1">
          ...
          <div className="flex items-center gap-4 mt-2">
            <span className="inline-block w-[35px] md:w-[48px] h-[35px] md:h-[48px] border border-[#3D6AD6] bg-white flex items-center justify-center rounded-full hover:bg-blue-100">
              <a href="#">
                <img
            ...
            <span className="inline-block w-[35px] md:w-[48px] h-[35px] md:h-[48px] border border-[#D73F8C] hover:bg-pink-100 bg-white flex items-center justify-center rounded-full">
              <a href="#">
                <img
            ...
            <span className="inline-block w-[35px] md:w-[48px] h-[35px] md:h-[48px] border border-black bg-white hover:bg-gray-100 flex items-center justify-center rounded-full">
              <a href="#">
                <img
            ...
            <span className="inline-block w-[35px] hover:bg-red-100 md:w-[48px] h-[35px] md:h-[48px] border border-[#BD081C] bg-white flex items-center justify-center rounded-full">
              <a href="#">
                <img
